...
class DescriptiveDetails:
    ...
    def get_col_meta(self) -> pd.DataFrame:
        ...
        self._col_meta["unique_rate"] = \
            (self._df.fillna(0).nunique()) * 100 / len(self._df)
    ...
    def get_descriptive_stat(self) -> dict:
        ...
        self._num_cols = self._col_meta.loc[
    ...
    def get_category_details(self) -> dict:
        ...
        obj_cols = self._col_meta.loc[
            self._col_meta["present_datatype"] == "object", "columns"
        ].tolist()
